...
export default function IndexPage() {
  return (
    <div className="min-h-screen relative">
      ...
      >
        <div className="absolute inset-0 bg-black/40" /> {/* Dark overlay for better readability */}
      </div>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <Card key={index} 
                  className="bg-white/95 backdrop-blur-sm shadow-lg p-8 hover-scale rounded-2xl">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} 
                  className="bg-white/95 backdrop-blur-sm shadow-lg rounded-2xl p-8 text-center hover-scale">
                  <div className="relative z-10">
