...
export function RankingTable({ players, onPlayerClick }: RankingTableProps) {
  ...
  const getLevelColor = (level: string) => {
    switch (level.toLowerCase()) {
      case 'pro': return 'bg-purple-100 text-purple-800 dark:bg-purple-800 dark:text-purple-100'
      case 'elite': return 'bg-yellow-100 text-yellow-800 dark:bg-yellow-800 dark:text-yellow-100'
